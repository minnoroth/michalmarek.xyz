            ...
            <div className="space-y-4">
                <div>
                    ...
                    <ul className="space-y-2 text-sm">
                        <li>
                            <span className="text-foreground">{dictionary.sections.tech.categories.frontend}</span>
                        ...
                        <li>
                            <span className="text-foreground">{dictionary.sections.tech.categories.backend}</span>
                            <ul className="ml-4 mt-1 space-y-1 text-muted-foreground">
