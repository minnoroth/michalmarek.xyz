...
import { CardSection } from '@/config/sections';
import { useRouter, useSearchParams } from 'next/navigation';

export function BusinessCard({ dictionary, locale, initialSection }: {
    ...
    const [currentSection, setCurrentSection] = useState<CardSection>(initialSection);
    ...
    const NavButton = ({ section, icon: Icon }: { section: CardSection; icon: LucideIcon }) => (
        <button
